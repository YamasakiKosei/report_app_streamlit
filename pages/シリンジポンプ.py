...
# 機能点検
st.subheader('機能点検')
fni1 = module.stObject('機能点検', '機能点検１', '１．スライダーが左右へ移動できるか')
fni2 = module.stObject('機能点検', '機能点検２', '２．電源を入れた際にセルフチェック機能が働くか')
fni3 = module.stObject('機能点検', '機能点検３', '３．開始・停止・早送り等のスイッチが正常に動作するか')
fni4 = module.stObject('機能点検', '機能点検４', '４．動作中・異常発生時のランプが点灯・点滅するか')
fni5 = module.stObject('機能点検', '機能点検５', '５．フックが正常に動作するか')
module.Checkbox(fni1, fni2, fni3, fni4, fni5)
st.divider()

# 性能点検
st.subheader('性能点検')
set1, peri1 = module.Flow(3) # 流量点検
set2, set3, peri2 = module.Pressure() # 閉塞圧点検
peri3 = module.stObject('性能点検', '性能点検３', '３．シリンジサイズの検出されるか')
peri4 = module.stObject('性能点検', '性能点検４', '４．押し子・シリンジ外れ警報がなるか')
