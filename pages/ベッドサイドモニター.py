...
# 性能点検
peri1, peri2 = module.Spo2() # 酸素飽和度、脈拍数
st.write('**心電図**')
peri3 = module.stObject('性能点検', '心電図', '３．入力した波形が正常に出力されるか')
module.Checkbox(peri3)
set1, peri4 = module.Temperature() # 体温部
set2, peri5, set3, peri6 = module.blood_pressure() # 血圧部
