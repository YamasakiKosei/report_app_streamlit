...
outi4 = module.stObject('外装点検', '外装点検４', '４．チューブクランプの破損がないか')
outi5 = module.stObject('外装点検', '外装点検５', '５．電源コードの破損がないか')
module.Checkbox(outi1, outi2, outi3, outi4, outi5)
st.divider()

# 機能点検
st.subheader('機能点検')
fni1 = module.stObject('機能点検', '機能点検１', '１．ドア開閉レバーがきちんと閉まるか')
fni2 = module.stObject('機能点検', '機能点検２', '２．電源を入れた際にセルフチェック機能が働くか')
fni3 = module.stObject('機能点検', '機能点検３', '３．ドアを開けたとき自動的にチューブクランプが閉じるか')
fni4 = module.stObject('機能点検', '機能点検４', '４．動作中・異常発生時のランプが点灯・点滅するか')
module.Checkbox(fni1, fni2, fni3, fni4)
st.divider()

# 性能点検
st.subheader('性能点検')
set1, peri1 = module.Flow(10) # 流量点検
set2, set3, peri2 = module.Pressure() # 閉塞圧点検
peri3 = module.stObject('性能点検', '性能点検３', '３．滴下センサー動作の確認')
peri4 = module.stObject('性能点検', '性能点検４', '４．気泡検知機能の確認')
module.Checkbox(peri3, peri4)
st.divider()
...
def unique(sheet):
    # 性能点検
    sheet['C25'] = f'{set1} ± 10％'
    sheet['C26'] = str(round(set2, 1)) + ' ± ' + str(round(set3, 1))
    sheet['F25'] = peri1.value
    sheet['F26'] = peri2.value
    # 備考
    sheet['B29'] = text_area.value
    # 総合評価
